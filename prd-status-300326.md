...
| CS-003 | `/cs/claims/create` | Wizard 3 langkah dengan autosave, validation summary, sticky action footer | Parsial | Perlu perbaikan | Wizard 3 langkah, lookup notification, upload evidence, dan sticky footer action sudah tersedia | Gap utama kini terfokus pada belum adanya autosave indicator dan validation summary lintas step; sticky action footer secara visual sudah hadir | `app/pages/cs/claims/create.vue` | High |
...
| CS-D-008 | Sticky action create claim sudah hadir, tetapi belum distandarkan ke reusable pattern | Parsial | Perlu perbaikan | `app/pages/cs/claims/create.vue` | Action footer sticky sudah terpasang pada wizard create claim, tetapi belum memakai shared component/pattern yang sama dengan flow kritikal lain | Medium |
