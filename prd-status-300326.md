...
| CS-003 | `/cs/claims/create` | Wizard 3 langkah dengan autosave, validation summary, sticky action footer | Sesuai | Sudah sesuai | Wizard 3 langkah, lookup notification, upload evidence, drag/drop, image preview aktual, dan sticky footer action sudah tersedia sesuai kebutuhan PRD saat ini | Tidak ada gap utama; fitur wizard, autosave, validation summary lintas step, sticky action footer, drag/drop upload, image preview, dan validasi upload 5MB sudah berjalan | `app/pages/cs/claims/create.vue` | Medium |
