        ...
        <nav class="flex-1 space-y-1">
          ...
          >
            <component
              :is="link.icon"
              :size="18"
              :class="link.active ? 'text-black' : 'group-hover:text-[#B6F500]'"
            />
            {{ link.label }}
            <span
              v-if="link.badge"
              class="ml-auto bg-blue-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.5)]"
            >
              {{ link.badge }}
            </span>
          </button>
        ...
        <div class="p-5 rounded-[28px] bg-white/5 border border-white/10 mt-10 backdrop-blur-md">
          <div class="flex items-center gap-3 mb-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[9px] text-[#B6F500] uppercase tracking-widest font-black italic">
        ...
        <header class="h-24 px-12 flex items-center justify-between border-b border-white/5 bg-[#050505]/40 backdrop-blur-xl sticky top-0 z-40">
          <div class="flex items-center bg-white/5 border border-white/10 rounded-2xl px-5 py-3 w-[450px] focus-within:border-[#B6F500]/40 transition-all group">
            ...
            <input
              ...
              class="bg-transparent border-none outline-none px-4 text-sm w-full placeholder:text-white/10 font-medium"
            >
          ...
          <div class="flex items-center gap-8">
            ...
            <div class="relative group cursor-pointer">
              ...
              />
              <div class="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-[#B6F500] rounded-full border-2 border-[#050505] shadow-[0_0_10px_#B6F500]" />
            </div>
            ...
            <div class="text-right">
              ...
              <p class="text-[10px] text-white/30 font-bold uppercase tracking-tighter">
                Karawang, ID • 23:45
              </p>
            </div>
          </div>
          ...
          <div class="max-w-[1200px] mx-auto space-y-12">
            ...
            <div class="flex justify-between items-end animate-in fade-in slide-in-from-bottom-4 duration-700">
              <div>
                ...
                <p class="text-white/30 mt-3 font-medium text-lg italic tracking-tight">
            ...
            <div class="grid grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-100">
              <div
                ...
                :key="i"
                class="p-8 backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[40px] group hover:bg-white/10 hover:border-[#B6F500]/30 transition-all cursor-pointer relative overflow-hidden"
              >
                ...
                <p class="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] mb-1 relative z-10">
                  {{ kpi.label }}
                </p>
                <h4 class="text-4xl font-black tracking-tighter italic relative z-10">
                  {{ kpi.value }}
                </h4>
              </div>
            </div>
              ...
              <div class="col-span-8 backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[48px] p-10 relative overflow-hidden">
                <div class="flex justify-between items-center mb-14">
                  <div>
                    ...
                    <p class="text-xs text-white/20 font-bold uppercase tracking-widest mt-1 italic">
                  ...
                  <div class="flex gap-2">
                    <div
                      ...
                      :key="t"
                      :class="['px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest cursor-pointer transition-all', t === 'Weekly' ? 'bg-[#B6F500] text-black shadow-[0_0_15px_rgba(182,245,0,0.3)]' : 'bg-white/5 text-white/20 hover:text-white']"
                    >
                      {{ t }}
                    </div>
                  </div>
                ...
                <div class="h-64 flex items-end justify-between gap-6 px-4">
                  ...
                  >
                    ...
                    >
                      <div
                        v-if="idx === 3"
                        class="absolute -top-12 left-1/2 -translate-x-1/2 bg-white text-black text-[9px] font-black px-3 py-1.5 rounded-lg shadow-2xl whitespace-nowrap uppercase italic tracking-tighter"
                      >
                        Puncak Klaim
                      </div>
                    </div>
                ...
                <!-- Abstract Grid Lines -->
                <div class="absolute inset-x-10 bottom-24 h-px bg-white/5 pointer-events-none" />
                <div class="absolute inset-x-10 bottom-44 h-px bg-white/5 pointer-events-none" />
              </div>
              ...
              <div class="col-span-4 space-y-8">
                <div class="bg-gradient-to-br from-[#B6F500] to-[#8ac500] p-10 rounded-[48px] text-black flex flex-col justify-between h-64 relative overflow-hidden group cursor-pointer shadow-2xl shadow-[#B6F500]/10">
                  <div class="relative z-10">
                    ...
                    <h4 class="text-3xl font-black leading-tight mt-3 italic tracking-tighter">
                      Vendor MTC butuh perhatian khusus.
                    </h4>
                    <p class="text-xs font-bold opacity-60 mt-2">
                  ...
                  <Package
                    :size="180"
                    class="absolute -bottom-10 -right-10 opacity-10 rotate-12 group-hover:rotate-0 transition-transform duration-1000"
                  />
                </div>
            ...
            <div class="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-[48px] overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-300">
              <div class="p-10 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                <div>
                  ...
                  <p class="text-[10px] text-white/20 font-black uppercase tracking-widest mt-2">
              ...
              <table class="w-full text-left">
                <thead class="bg-white/5">
                  <tr>
                    <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30">
                      ID Claim / S/N
                    </th>
                    <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30">
                      Branch & Agent
                    ...
                    <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30 text-right">
                      Activity
                    </th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-white/5">
                  <tr
                    ...
                    :key="i"
                    class="hover:bg-white/5 transition-all duration-300 group cursor-pointer"
                  >
                    <td class="px-10 py-7">
                      <div class="font-black text-[#B6F500] italic tracking-tighter">
                        {{ row.id }}
                      </div>
                      <div class="text-[9px] text-white/20 font-mono mt-1 uppercase">
                        SN: 8829-Z-{{ 2024 + i }}
                      </div>
                    </td>
                    <td class="px-10 py-7">
                    ...
                    <td class="px-10 py-7">
                      ...
                      <p class="text-[9px] text-white/20 uppercase font-black tracking-widest mt-1">
                        Electronics • TV
                      </p>
                    </td>
                    <td class="px-10 py-7">
                    ...
                    <td class="px-10 py-7 text-right">
                      <p class="text-xs font-black text-white/20 uppercase italic">
                        {{ row.time }}
                      </p>
