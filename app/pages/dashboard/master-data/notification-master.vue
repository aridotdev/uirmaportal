    ...
    <div class="relative rounded-[36px] border border-white/10 bg-white/5 overflow-hidden backdrop-blur-2xl animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200">
      ...
      <div class="px-6 py-5 border-t border-white/5 bg-white/2 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <select
              ...
              class="bg-white/5 border border-white/10 rounded-xl px-3 py-1.5 text-xs font-black text-white/60 outline-none focus:border-amber-500/50 transition-all cursor-pointer"
            >
              <option
                :value="5"
                class="bg-[#080808]"
          ...
          <p class="text-[10px] font-black uppercase tracking-[0.2em] text-white/30 italic">
            Showing {{ table.getState().pagination.pageIndex * table.getState().pagination.pageSize + 1 }} to {{ Math.min((table.getState().pagination.pageIndex + 1) * table.getState().pagination.pageSize, filteredList.length) }} of <span class="text-amber-400 font-black">{{ filteredList.length }}</span> records
          </p>
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex items-center px-4 py-2 rounded-xl bg-white/5 border border-white/5 text-[10px] font-black uppercase tracking-[0.2em] text-white/30">
