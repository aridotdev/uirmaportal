...
import { AlertCircle, Search, RefreshCw, Plus, Eye, Power, CheckCircle, Pencil, Save, X, CalendarDays, Fingerprint, User2, History, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-vue-next'
        ...
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <select
              ...
              class="bg-white/5 border border-white/10 rounded-xl px-3 py-1.5 text-xs font-black text-white/60 outline-none focus:border-red-500/50 transition-all cursor-pointer"
            >
              <option
                :value="5"
                class="bg-[#080808]"
          ...
          <p class="text-[10px] font-black uppercase tracking-[0.2em] text-white/30 italic">
            ...
            of
            <span class="text-red-500">{{ filteredList.length }}</span>
            records
          </p>
        </div>
