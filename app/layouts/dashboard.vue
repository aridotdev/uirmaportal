        ...
        <div class="mt-10 rounded-[28px] border border-white/10 bg-white/5 p-5 backdrop-blur-md">
          <div class="mb-4 flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              <p class="truncate text-sm font-black">Zaina Riddle</p>
              <p class="text-[9px] font-black uppercase tracking-widest text-[#B6F500] italic">System Administrator</p>
            </div>
          </div>
        ...
        <header class="sticky top-0 z-40 flex h-24 shrink-0 items-center justify-between border-b border-white/5 bg-[#050505]/70 px-6 backdrop-blur-xl supports-[backdrop-filter]:bg-[#050505]/45 lg:px-12">
          ...
          <div class="ml-6 hidden items-center gap-8 lg:flex">
            ...
            <div class="group relative cursor-pointer">
              <Bell :size="22" class="text-white/30 transition-colors group-hover:text-white" />
            ...
            <div class="text-right">
              ...
              <p class="text-[10px] font-bold uppercase tracking-tighter text-white/30">Karawang, ID • 23:45</p>
            </div>
          </div>
        </header>
