...
CREATE INDEX `notification_master_fiscal_label_idx` ON `notification_master` (`fiscalLabel`);--> statement-breakpoint
CREATE INDEX `notification_master_fiscal_year_idx` ON `notification_master` (`fiscalYear`);--> statement-breakpoint
...
CREATE INDEX `claim_fiscal_label_idx` ON `claim` (`fiscalLabel`);--> statement-breakpoint
CREATE INDEX `claim_fiscal_year_idx` ON `claim` (`fiscalYear`);--> statement-breakpoint
CREATE INDEX `claim_calendar_ym_idx` ON `claim` (`calendarYear`,`calendarMonth`);--> statement-breakpoint
CREATE INDEX `claim_fiscal_year_half_idx` ON `claim` (`fiscalYear`,`fiscalHalf`);--> statement-breakpoint
...
CREATE INDEX `vendor_claim_fiscal_label_idx` ON `vendor_claim` (`fiscalLabel`);--> statement-breakpoint
CREATE INDEX `vendor_claim_fiscal_year_idx` ON `vendor_claim` (`fiscalYear`);--> statement-breakpoint
CREATE INDEX `vendor_claim_calendar_ym_idx` ON `vendor_claim` (`calendarYear`,`calendarMonth`);--> statement-breakpoint
